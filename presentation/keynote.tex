...
\begin{block}{Opzione}
Un opzione finanziaria \`e un contratto, caratterizzabile tramite una funzione \emph{Payoff} finale, che dipende da un sottostante che evolve stocasticamente.
\end{block}
\begin{block}{Pricing}
