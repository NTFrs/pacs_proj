...
Un opzione finanziaria \`e un contratto, caratterizzabile tramite una funzione \emph{Payoff} finale, che dipende da un sottostante che evolve stocasticamente. Il problema di \emph{pricing} consiste nel trovare il prezzo equo di tale opzione. Questo problema pu\`o essere ricondotto alla risoluzione di un equazione integro-differenziale.
