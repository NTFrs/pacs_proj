...
\end{equation*}
su una griglia qualunque. Notare come si può uscire dal dominio a causa del termine $x+y$\\
...
No \emph{mesh adapting} in 2d & \emph{Mesh adapting} anche in 2d, migliorando le prestazioni\\
