...
\begin{frame}[c]
 ...
 Utilizzando le funzioni della librearia \textsf{deal.ii}, è facile adattare la griglia:
 \begin{figure}
 ...
 \begin{subfigure}{0.48\linewidth}
  ...
  \caption{soluzione adattata}}
 \end{subfigure}
 \caption{Adattazione di griglia per una Call Europea 2d in forma \emph{LogPrice}}
 \end{figure}
\end{frame}
