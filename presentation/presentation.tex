...
\begin{frame}
 ...
 Seguendo la linea di \textsf{deal.ii}, è stata creata una serie classi principali che rappresentano il problema e gestiscono creazione griglia, assemblaggio sistema e soluzione. Templatizzata sulla dimensione.
 \end{block}
 ...
 \begin{block}{Classi Integrali}
  Il calcolo della parte integrale è fatto da queste classi, e le Opzioni salvano un puntatore a un oggetto di questo tipo. Anche in questo caso sono dei template in cui il parametro rappresenta la dimensione.
 \end{block}
