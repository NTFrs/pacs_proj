...
Siano ora $\Omega_h$ una triangolazione con $N+1$ nodi di $[x_{min},x_{max}]$ e $0= t_0\leq t_1\leq ... \leq t_N=T$ una griglia temporale. Cerchiamo quindi una soluzione del tipo: $$u_h(x,t_n)=\sum_{j=0}^{N}a_j(t_n)\phi_j(x),$$
