...
Un approccio che abbiamo deciso di non esplorare è il cambio di variabili $Se^y=z$ a livello equazione. In tal caso si otterrebbe un equazione a coefficienti non costanti, ma la parte integrale potrebbe essere più semplice, ma sarebbe complicato da estendere al caso bidimensionale.\\
