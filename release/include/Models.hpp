...
public:
        ...
        virtual inline unsigned get_type()      const
        {
                return type;
        };

        //! Returns the Spot Price
        virtual inline double get_spot()        const
        {
                return S0;
        };
        //! Returns the Volatility
        virtual inline double get_vol()         const
        {
                return sigma;
        };
        //! Returns the pointer to che class (needed in OptionBase<dim> constructors)
        virtual inline Model * get_pointer()
        {
                return this;
        };

        virtual inline double get_lambda()      const
        {
                return 0.;
        };

        virtual inline double get_p()           const
        {
                return 0.;
        };
        virtual inline double get_lambda_p()    const
        {
                return 0.;
        };
        virtual inline double get_lambda_m()    const
        {
                return 0.;
        };

        virtual inline double get_nu()          const
        {
                return 0.;
        };
        virtual inline double get_delta()       const
        {
                return 0.;
        };
